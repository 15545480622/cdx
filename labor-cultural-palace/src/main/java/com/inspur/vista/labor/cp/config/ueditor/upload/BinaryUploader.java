...
import com.inspur.vista.labor.cp.config.ueditor.PathFormat;
...
import com.inspur.vista.labor.cp.config.ueditor.define.FileType;
...
public class BinaryUploader {
	...
	public static final State save(HttpServletRequest request, Map<String, Object> conf, CpActivityBaseService cpActivityBaseService) {
		...
		try {
			...
			State storageState = StorageManager.saveFileByInputStream(request, is, path, picName, maxSize, file, cpActivityBaseService);
