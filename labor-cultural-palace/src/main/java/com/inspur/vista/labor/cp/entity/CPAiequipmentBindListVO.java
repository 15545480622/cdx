...
/**
 * @Title: CPAiequipmentBindListVO
 * @Description: 智能设备绑定信息
 * @Author: liuzq
 * @CreateDate: 2020/03/07 15:54
 * @Version: 1.0
 */
@ApiModel(value = "智能设备绑定列表信息", description = "智能设备绑定列表信息")
public class CPAiequipmentBindListVO implements Serializable {
    ...
    public String toString() {
        return "CPAiequipmentBindListVO{" +
                "id='" + id + '\'' +
