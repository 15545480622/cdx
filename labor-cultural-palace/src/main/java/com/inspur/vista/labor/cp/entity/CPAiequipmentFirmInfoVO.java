...
/**
 * @Title: CPAiequipmentFirmInfoDetailVO
 * @Description: 智能设备厂商信息
 * @Author: liuzq
 * @CreateDate: 2020/03/07 15:05
 * @Version: 1.0
 */
@ApiModel(value = "智能设备厂商详细信息", description = "智能设备厂商详细信息")
public class CPAiequipmentFirmInfoVO implements Serializable {
    ...
    public String toString() {
        return "CPAiequipmentFirmInfoDetailVO{" +
                "id='" + id + '\'' +
                ", cpId='" + cpId + '\'' +
                ", name='" + name + '\'' +
                ", url='" + url + '\'' +
