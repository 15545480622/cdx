...
/**
 * @Title: CPAiequipmentInfoDetailVO
 * @Description: 智能设备信息
 * @Author: liuzq
 * @CreateDate: 2020/03/07 14:37
 * @Version: 1.0
 */
@ApiModel(value = "智能设备详细信息", description = "智能设备详细信息")
public class CPAiequipmentInfoVO implements Serializable {
    ...
    public String toString() {
        return "CPAiequipmentInfoDetailVO{" +
                "id='" + id + '\'' +
                ", cpId='" + cpId + '\'' +
                ", firm=" + firm +
