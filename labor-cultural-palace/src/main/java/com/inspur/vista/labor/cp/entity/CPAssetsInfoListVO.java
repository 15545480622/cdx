...
/**
 * @ClassName: CPAssetsListVO
 * @Description: 文化宫资产VO
 * @authur: wangxueying01
 * @CreatDate: 2019/12/17 9:54
 */
@ApiModel(value = "资产列表信息", description = "资产列表信息")
public class CPAssetsInfoListVO implements Serializable {
