...
/**
 * @ClassName: CPBannerListVO
 * @Description: 文化宫banner图ListVO
 * @authur: wangxueying01
 * @CreatDate: 2020/3/27 9:36
 */
@ApiModel(value = "banner图ListVO", description = "banner图ListVO")
public class CPBannerListVO implements Serializable {
