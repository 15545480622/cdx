 ...
 * @Version: 1.0
 */
public class CPInfoApplyAdd implements Serializable {
     ...
     * 附件
     */
    @ApiModelProperty(value = "附件id，用逗号分隔", required = true, position = 35)
    private String applyFileIds;

    /**
     * 申请原因
     */
    @ApiModelProperty(value = "申请原因", required = true, position = 36)
    private String applyReason;

    /**
     * 提交人
     */
    @ApiModelProperty(value = "提交人", required = true, position = 37)
    ...
    public String getApplyFileIds() {
        return applyFileIds;
    }

    public void setApplyFileIds(String applyFileIds) {
        this.applyFileIds = applyFileIds;
    }
