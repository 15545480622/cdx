 ...
 * @Version: 1.0
 */
@ApiModel(value = "专业人才新增", description = "专业人才新增")
public class CPProfessionalTalentAdd implements Serializable {
     ...
     * 附件id，逗号分隔
     */
    @ApiModelProperty(value = "附件id，逗号分隔", required = true, position = 14)
    ...
    public String toString() {
        return "CPProfessionalTalentAdd{" +
                "id='" + id + '\'' +
                ", cpId='" + cpId + '\'' +
                ", name='" + name + '\'' +
                ", idcard='" + idcard + '\'' +
