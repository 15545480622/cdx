...
/**
 * @ClassName: CPProfessionalTalentDetailVO
 * @Description: 专业人才库VO
 * @authur: wangxueying01
 * @CreatDate: 2019/12/17 9:38
 */
@ApiModel(value = "专业人才库详情", description = "专业人才库详情")
public class CPProfessionalTalentVO implements Serializable {
