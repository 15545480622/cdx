...
/**
 * @ClassName: CPRegulationListVO
 * @Description: 文化宫制度管理VO
 * @authur: wangxueying01
 * @CreatDate: 2020/1/3 10:22
 */
@ApiModel(value = "文化宫制度管理列表信息", description = "文化宫制度管理列表信息")
public class CPRegulationListVO implements Serializable {
