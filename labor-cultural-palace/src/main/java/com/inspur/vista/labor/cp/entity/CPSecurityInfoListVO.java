...
/**
 * @ClassName: CPSecurityInfoListVO
 * @Description: 安全管理列表信息
 * @authur: wangxueying01
 * @CreatDate: 2020/4/7 19:53
 */
@ApiModel(value = "安全管理列表信息", description = "安全管理列表信息")
public class CPSecurityInfoListVO implements Serializable {
